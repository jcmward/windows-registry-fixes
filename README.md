...
By comparison, Windows 11 didn't seem to be as big a step down for users,
but there was one thing that ***really*** irked me when I first used it: the
broken context (right-click) menu.  That one is a doozy, as it directly
interferes with my productivity.  Fortunately, as with many other UI issues,
there's a registry hack that can be used as a workaround.
